...
def get_student(num_classes):
    model = models.shufflenet_v2_x1_5(weights="IMAGENET1K_V1") #carico dei pesi pre-addestrati sul database di ImageNet, una sorta di Transfer Learning. Altrimenti avrei valori random
